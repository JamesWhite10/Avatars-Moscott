...
void main() {
  ...
  vec3 rgb =
  firstTexture2D.rgb * blendingFirstTexture +
  secondTexture2D.rgb * blendingSecondTexture +
  thirdTexture2D.rgb * blendingThirdTexture +
  fourthTexture2D.rgb * blendingFourthTexture;

  vec4 diffuseColor = vec4( rgb.rgb, opacity );
